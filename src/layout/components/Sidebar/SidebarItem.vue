<template>
  <div v-if="!props.item.meta || !props.item.meta.hidden">
    ...
    <el-sub-menu v-else ref="subMenuRef" :index="resolvePath(props.item.path)" popper-append-to-body>
      <template #title>
...
<script lang="ts" setup>
  ...
  // const bool = hasOneShowingChild(item.value.children, item) && (!onlyOneChild.children||onlyOneChild.noShowingChildren)&&!item.value.alwaysShow
  // console.log('-----', item.value.path, meta.value.hidden, bool)
